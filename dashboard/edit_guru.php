                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            $get_guru = get_guru($_GET['id_guru']);

                            if (isset($_POST['edit_guru'])) {
                                update_guru($_POST, $_GET['id_guru']);
                            }
                            ...
                            <form method="POST">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control mt-1" name="nama_guru" value="<?= $get_guru['nama_guru'] ?>">
                                </div>
                                <div class="text-end">
                                    <button class="btn btn-primary mt-3" type="submit" name="edit_guru">Edit</button>
                                </div>
                            </form>
                        </div>
                    </div>
